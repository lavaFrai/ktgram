 ...
 *
 * @param requestId Signed 32-bit identifier of the request, which will be received back in the [ChatShared][ru.lavafrai.ktgram.types.ChatShared] object. Must be unique within the message
